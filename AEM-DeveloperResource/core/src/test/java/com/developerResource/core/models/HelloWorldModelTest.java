 ...
 */
package com.developerResource.core.models;
...
import com.developerResource.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "AEM-DeveloperResource/components/helloworld");
