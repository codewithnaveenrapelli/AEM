...
![AEM AUthor](https://github.com/DeveloperResource-NaveenR/AEM/Images/Multiple%20Publish%20Instance.webp)
...
![AEM AUthor](https://github.com/DeveloperResource-NaveenR/AEM/Images/start.png)
...
![AEM Instance](https://github.com/DeveloperResource-NaveenR/AEM/Images/start%202.png)

5. After login, it will open below screen

![AEM Login Page](https://github.com/DeveloperResource-NaveenR/AEM/Images/login.png)

6. Clicking on the below question mark sign will help us to see the Adobe Experience Manager version.

![AEM Version Check](https://github.com/DeveloperResource-NaveenR/AEM/Images/version.png)
...
![AEM Version Check](https://github.com/DeveloperResource-NaveenR/AEM/Images/AEM%20Publish.webp)
...
![AEM Replication Image](https://github.com/DeveloperResource-NaveenR/AEM/Images/Replication%20Image/replication%20Image%20Author.png)


3. Then click on “Edit” after Settings to open the Agent Settings dialog box to enter the details.

![AEM Replication Edit](https://github.com/DeveloperResource-NaveenR/AEM/Images/Replication%20Image/replication%203.png)
...
![AEM Replication Edit](https://github.com/DeveloperResource-NaveenR/AEM/Images/Replication%20Image/replication%204.png)
...
![AEM Replication Edit](https://github.com/DeveloperResource-NaveenR/AEM/Images/Replication%20Image/replication%205.png)
...
![AEM Replication Edit](https://github.com/DeveloperResource-NaveenR/AEM/Images/Replication%20Image/replication%206.png)

16. you can go to the author package manager, select a package and from the more option replicate the package.

![AEM Replication Edit](https://github.com/DeveloperResource-NaveenR/AEM/Images/Replication%20Image/replicate2.png)
